...
namespace API.Controllers
{
    ...
    public class PagamentosController : ControllerBase
    {
        ...
        public PagamentosController(LOJA_PETContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Pagamento>> PostPagamento(Pagamento pagamento)
        {
            ...
            return CreatedAtAction("GetPagamento", new { id = pagamento.IdPagamentos }, pagamento);
        }
        ...
        {
            return _context.Pagamentos.Any(e => e.IdPagamentos == id);
        }
    }
}
